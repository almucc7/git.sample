...
export const createUsersRouter = (authInterceptor, fileInterceptor, usersController) => {
    ...
    usersRouter.get('/:id', authInterceptor.authenticate, authInterceptor.isUser, usersController.getById.bind(usersController));
    usersRouter.post('/register', fileInterceptor.multer.bind(fileInterceptor), usersController.create.bind(usersController));
